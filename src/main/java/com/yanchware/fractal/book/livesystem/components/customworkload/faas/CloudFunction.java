...
public class CloudFunction extends CustomFunctionWorkload implements LiveSystemComponent {
    public final static Type TYPE = new Type(InfrastructureDomain.CUSTOM_WORKLOAD, ServiceDeliveryModel.FAAS, new PascalCaseString("CloudFunction"));

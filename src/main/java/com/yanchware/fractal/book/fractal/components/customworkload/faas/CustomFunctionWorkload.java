package com.yanchware.fractal.book.fractal.components.customworkload.faas;
...
public abstract class CustomFunctionWorkload extends GitCustomWorkload {
    public CustomFunctionWorkload(
            Id id,
            Version version,
            String displayName,
            String description,
